"""
Django settings for Gym Pigs project.
...
ALLOWED_HOSTS = ['gympigs.herokuapp.com', 'localhost']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'shoppingbag.context.cart_contents',
            ],
            'builtins': [
...
if 'USE_AWS' in os.environ:
    AWS_STORAGE_BUCKET_NAME = 'gym-pigs'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'gympigs@example.com'
else:
